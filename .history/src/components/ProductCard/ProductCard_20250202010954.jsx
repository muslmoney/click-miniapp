  ...
  return (
    <div className={styles.inCart}>
      ...
      <div className={styles.info}>
        ...
        {quantity > 1 ? (
            <>
              <img src='/' onClick={handleDecrease} className={styles.decrease}/>
              <span className={styles.quantity}>{quantity}</span>
              <img src='/add.png' onClick={handleIncrease} className={styles.increase}/>
            </>
          ) : (
            <div className={styles.cartIcon} onClick={() => removeFromCart(id)}>
